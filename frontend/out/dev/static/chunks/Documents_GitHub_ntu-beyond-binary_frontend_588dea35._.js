...
"[project]/Documents/GitHub/ntu-beyond-binary/frontend/app/profile-select/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProfileSelectPage() {
    ...
    const [profiles, setProfiles] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$ntu$2d$beyond$2d$binary$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [selectedIndex, setSelectedIndex] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$ntu$2d$beyond$2d$binary$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [scanMode, setScanMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$ntu$2d$beyond$2d$binary$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$ntu$2d$beyond$2d$binary$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProfileSelectPage.useEffect": ()=>{
            ...
            const interval = setInterval({
                "ProfileSelectPage.useEffect.interval": ()=>{
                    setSelectedIndex({
                        "ProfileSelectPage.useEffect.interval": (prev)=>(prev + 1) % (profiles.length + 1)
                    }["ProfileSelectPage.useEffect.interval"]); // +1 for "New Profile"
                }
            }["ProfileSelectPage.useEffect.interval"], 2000);
            return ({
                "ProfileSelectPage.useEffect": ()=>clearInterval(interval)
            })["ProfileSelectPage.useEffect"];
        }
    }["ProfileSelectPage.useEffect"], [
        scanMode,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$ntu$2d$beyond$2d$binary$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProfileSelectPage.useEffect": ()=>{
            const handleKeyPress = {
                "ProfileSelectPage.useEffect.handleKeyPress": (e)=>{
                    if (e.key === 'Enter' || e.key === ' ') {
                        selectProfile(selectedIndex);
                    } else if (e.key === 'ArrowDown') {
                        setSelectedIndex({
                            "ProfileSelectPage.useEffect.handleKeyPress": (prev)=>(prev + 1) % (profiles.length + 1)
                        }["ProfileSelectPage.useEffect.handleKeyPress"]);
                    } else if (e.key === 'ArrowUp') {
                        setSelectedIndex({
                            "ProfileSelectPage.useEffect.handleKeyPress": (prev)=>(prev - 1 + profiles.length + 1) % (profiles.length + 1)
                        }["ProfileSelectPage.useEffect.handleKeyPress"]);
                    }
                }
            }["ProfileSelectPage.useEffect.handleKeyPress"];
            ...
            return ({
                "ProfileSelectPage.useEffect": ()=>window.removeEventListener('keydown', handleKeyPress)
            })["ProfileSelectPage.useEffect"];
        }
    }["ProfileSelectPage.useEffect"], [
        selectedIndex,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$ntu$2d$beyond$2d$binary$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$ntu$2d$beyond$2d$binary$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            profiles.map((profile, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$ntu$2d$beyond$2d$binary$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                ${selectedIndex === index ? 'bg-white scale-105 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]' : 'bg-white/90 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:scale-105'}`,
                                    children: [
                                        ...
                                        selectedIndex === index && scanMode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$ntu$2d$beyond$2d$binary$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
              ...
              ${selectedIndex === profiles.length ? 'bg-green-400 scale-105 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]' : 'bg-green-300 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:scale-105'}`,
                                children: [
                                    ...
                                    selectedIndex === profiles.length && scanMode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$ntu$2d$beyond$2d$binary$2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "absolute inset-0 border-4 border-green-500 rounded-2xl animate-pulse pointer-events-none"
                                    }, void 0, false, {
                                        fileName: "[project]/Documents/GitHub/ntu-beyond-binary/frontend/app/profile-select/page.tsx",
                                        lineNumber: 179,
...
_s(ProfileSelectPage, "2llOn1B87QxeyrxtKx8DkonmDkA=", false, function() {
    return [
...
_c = ProfileSelectPage;
var _c;
__turbopack_context__.k.register(_c, "ProfileSelectPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/Documents/GitHub/ntu-beyond-binary/frontend/node_modules/lucide-react/dist/esm/icons/user.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const User = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$ntu$2d$beyond$2d$binary$2f$frontend$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$createLucideIcon$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("user", __iconNode);
;
 //# sourceMappingURL=user.js.map
}),
"[project]/Documents/GitHub/ntu-beyond-binary/frontend/node_modules/lucide-react/dist/esm/icons/user.js [app-client] (ecmascript) <export default as User>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "User",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$ntu$2d$beyond$2d$binary$2f$frontend$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$user$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]
]);
...
//# sourceMappingURL=Documents_GitHub_ntu-beyond-binary_frontend_588dea35._.js.map