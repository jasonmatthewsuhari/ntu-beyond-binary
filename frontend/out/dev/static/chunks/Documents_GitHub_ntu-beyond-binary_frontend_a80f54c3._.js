...
_s(usePassiveSensing, "q+KtVqDpc+d1CbQGCquakUEIl2g=", false, function() {
    return [
...
function LockOnScreen({ detectedInput, onConfirmed, onTimeout }) {
    ...
    const { detectedInput: confirmInput, videoRef, status } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Documents$2f$GitHub$2f$ntu$2d$beyond$2d$binary$2f$frontend$2f$lib$2f$use$2d$passive$2d$sensing$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePassiveSensing"])(sensingEnabled && !confirmed, {
        ...
        disableVoiceVolume: detectedInput === 'head',
        suppressVoiceWhileSpeaking: true,
        allowedInputTypes: detectedInput === 'head' ? [
            'head'
        ] : undefined
    });
    const messages = {
...
//# sourceMappingURL=Documents_GitHub_ntu-beyond-binary_frontend_a80f54c3._.js.map